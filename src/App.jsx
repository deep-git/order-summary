...
function App() {
  ...
  return (
    <div className="relative bg-primary_paleblue w-full min-h-screen font-redhat flex justify-center items-center">
      <picture>
        <source media="(min-width: 1024px)" srcSet="/pattern-background-desktop.svg"/>
        <img src="/pattern-background-mobile.svg" alt="Curved wave background" className="absolute z-10 top-0 left-0 right-0 w-full -my-[20px] h-1/3 md:h-1/2"/>
      </picture>
      ...
      <main className="z-20 w-[325px] rounded-2xl bg-white overflow-hidden text-center shadow-[0px_10px_20px_rgba(56,41,224,0.2)] md:w-[400px]">
        <img src="/illustration-hero.svg" alt="Illustration hero image on top of card"/>
